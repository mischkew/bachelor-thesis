...
% give a source to an image. use it below \caption.
\newcommand{\source}[1]{\caption*{Source: {#1}} }

% visited on shortcut for image sources
\newcommand{\visited}{(visited on \today)}

\newcommand{\note}[1]{\textcolor{red}{#1}}
\newcommand{\class}[1]{\emph{#1}}
\newcommand{\name}[1]{\textit{#1}}

% command for referencing with both numer and title
...
%\include{Chapters/02-Userinteraction}
%\clearpage
...
%\include{Chapters/03.2-Processing_Pipeline}
%\clearpage

%\part{Approximation}
% Dimitri
\subfile{Chapters/04-Approximation}
%\include{Chapters/04-Approximation}
\cleardoublepage

%\part{Plates}
\subfile{Chapters/05-Plates}
%\include{Chapters/05-Plates}
\cleardoublepage

%\part{Graph}
\subfile{Chapters/06.1-Graph}
%\include{Chapters/06.1-Graph}
\cleardoublepage

%\part{Joints}
\subfile{Chapters/06.2-Joints}
%\include{Chapters/06.2-Joints}
\cleardoublepage

%\part{Curves}
\subfile{Chapters/07-Curves}
%\include{Chapters/07-Curves}
\cleardoublepage

%\part{Assembly}
\subfile{Chapters/08-Assembly}
%\include{Chapters/08-Assembly}
\cleardoublepage
...
%\include{Chapters/10-Classifiers}
\cleardoublepage

% %\part{Future Work}
% \subfile{Chapters/11-FutureWork}
% %\include{Chapters/11-FutureWork}
% \cleardoublepage
