...
\note{introduce plugins, associate a plugin with a thrree node to
  render stuff. use nodes to manage input models. plugin decides if
  input node is rendered, bringing node and three node together.}
