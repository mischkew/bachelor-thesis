...
five millimeters apart. After we find all \name{inherent} plates, we
...
primitive geometries. In Chapter~\ref{} \note{ref the
  chapter!} we give details about the \name{Classifier
  Method}.
...
\class{Report} instance. The garbage collector of
