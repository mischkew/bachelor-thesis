...
\TODO{better item names!! and maybe subsections instead of item because content of item is so large}
\begin{enumerate}
...
\TODO{maybe use minipages to show image on one side an the text on the other!}
