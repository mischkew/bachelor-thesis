...
Figure~\ref{}\note{figure}. A laser traces the outlines of a
planar cutting plan, producing plates which are cut out from
flat materials (Figure~\ref{}\note{figure}). Such materials
...
Figure~\ref{}\note{figure} we combined the plates of a bird
