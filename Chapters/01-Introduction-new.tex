...
Chapter~\sectionref{ch:architecture} and give an overview of the
most important data structures in
Chapter~\sectionref{ch:processingPipeline}. From
Chapter~\sectionref{ch:approximation} to Chapter~\sectionref{ch:curves} we
