...
\begin{figure}
  \centering
  \includegraphics[width=1\columnwidth]{02-user-interaction-report-error}
...
\begin{figure}
  \centering
  \includegraphics[width=1\columnwidth]{02-user-interaction-report-multiple}
  \caption{A sequence of conversions is summarized when all
